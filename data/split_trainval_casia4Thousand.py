...
#  Parameters
#------------------------------------------------------------------------------
IMAGE_DIR = "/media/antiaegis/storing/datasets/Iris/CASIA4/Thousand"
...
if __name__ == "__main__":
	...
	with open("data/casia4_thousand_train.txt", 'w') as fp:
		for file in train_list:
			fp.writelines(file+'\n')

	random.shuffle(valid_list)
	with open("data/casia4_thousand_valid.txt", 'w') as fp:
